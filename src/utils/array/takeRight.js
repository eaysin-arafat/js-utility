 ...
 * This function creates a new array containing up to 'n' elements from the end of the input list.
 *
 ...
 *
 * @returns {array} A new array containing up to 'n' elements from the end of the input array.
 *
