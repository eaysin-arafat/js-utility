 ...
 * This function creates a new array containing up to 'n' elements from the beginning of the input list.
 *
 ...
 *
 * @returns {array} A new array containing up to 'n' elements from the beginning of the input array.
 *
