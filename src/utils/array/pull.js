 ...
 *
 * @param {...array} arrays - One or more arrays to find the difference of.
 *
 * @returns {array} A new array containing elements present in the first iterable but not in any subsequent iterables.
 *
